...
const String signUpPatientRoute = '/patients/signup';
const String createPatientRoute = '/patients/create_patient';
const String getAllPatientsRoute = '/patients/all_patients';
const String getSinglePatientRoute = '/patients/single_patient';
const String updatePatientRoute = '/patients/update_patient';
const String deletePatientRoute = '/patients/delete_patient';
