...
class DoctorsAppointmentScreen extends StatelessWidget {
  ...
  DoctorsAppointmentScreen(this.isFromBottomSheet, {Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView.builder(
          itemCount: upcomingScheduleList.length,
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  upcomingScheduleList[index]["patientName"],
                                  style: const TextStyle(
                                    color: Colors.black54,
                                    fontSize: 15.0,
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              upcomingScheduleList[index]["time"],
                              style: const TextStyle(
                                  color: Colors.black54,
                                  fontSize: 14.0,
                                  fontWeight: FontWeight.w500
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Get.toNamed(doctorsAppointmentBookingScreen);
        },
