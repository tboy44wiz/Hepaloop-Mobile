...
class IndividualsHomeScreen extends StatelessWidget {
  IndividualsHomeScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetBuilder<IndividualStateController>(builder: (controller) {
        return (controller.individual.name != null) ?
        Container(
          height: Get.height,
          width: Get.width,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: NetworkImage(controller.individual.picture!),
                          fit: BoxFit.cover,
                        )),
                    child: null,
                  ),
                            ...
                            SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return InkWell(
                                    onTap: () {
                                      Get.toNamed(individualsAppointmentDetailScreen);
                                    },
                                    child: Card(
                                      elevation: 3.0,
